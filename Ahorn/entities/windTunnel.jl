...
@mapdef Entity "FactoryHelper/WindTunnel" WindTunnel(x::Integer, y::Integer, width::Integer=16, height::Integer=16, direction::String="Up", activationId::String="", strength::Real=100.0, startActive::Bool=false, particleColors::String="", showParticles::Bool=true)
