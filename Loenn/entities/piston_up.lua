...
piston.name = "FactoryHelper/PistonUp"
...
function piston.sprite(room, entity)
    ...
    fakeStartSprite:setJustification(0.0, 0.0)
    fakeEndSprite:setJustification(0.0, 0.0)
    startSprite:setJustification(0.0, 0.0)
    endSprite:setJustification(0.0, 0.0)
