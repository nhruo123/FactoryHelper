...
piston.name = "FactoryHelper/PistonLeft"
...
function piston.sprite(room, entity)
    ...
    baseSprite:setJustification(1.0, 0.0)
    fakeStartSprite:setJustification(1.0, 0.0)
    fakeEndSprite:setJustification(1.0, 0.0)
    startSprite:setJustification(1.0, 0.0)
    endSprite:setJustification(1.0, 0.0)
